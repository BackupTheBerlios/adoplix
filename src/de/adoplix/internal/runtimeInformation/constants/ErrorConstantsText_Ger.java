 ...
 * @author  dirk
 */
public abstract class ErrorConstantsText_Ger {
    ...
    public static final String CONFIGURATION_TYPE_FALSE = "Konfigurierter Wert ist vom falschen Typ.";
}
